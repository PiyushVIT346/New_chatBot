...
prompt = [
    ...
    when the user asks something about themselves. If they dont ask something about themselves dont read the description.Don't write about the user description until user ask for it."""]
